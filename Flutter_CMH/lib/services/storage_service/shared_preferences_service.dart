...
class SharedPrefsStorageService implements IStorageService {
  ...
  static const String _appCheckServerFingerprint =
      "app_check_server_fingerprint";
  ...
  String? getAppCheckServerFingerprint() {
    return _prefs?.getString(_appCheckServerFingerprint);
  }

  @override
  Future<bool>? setAppCheckServerFingerprint(String value) {
    return _prefs?.setString(_appCheckServerFingerprint, value);
  }

  @override
  Future<bool>? deleteAppCheckServerFingerprint() {
    return _prefs?.remove(_appCheckServerFingerprint);
  }
  ...
  Future<bool>? deleteAppSettings() async {
    ...
    bool? appCheckServerFingerprintDeleted =
        await deleteAppCheckServerFingerprint();
    ...
    return appLanguageDeleted != null &&
        ...
        appCheckServerFingerprintDeleted != null &&
        appCheckServerAddressDeleted != null &&
        appDefaultUrlDeleted != null &&
        appCheckServerFingerprintDeleted &&
